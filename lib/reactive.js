...
* @param {Function} [options.onLocalChange] Async function called when a local write is about to be sent to the server. Called as `(dataPayload:Object|Array)`
*
	...
	let reactives = {
		...
		*/
		async $touchLocal() {
			...
			await settings.onLocalChange(payload);
